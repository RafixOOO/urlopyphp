            ...
            for( var i=0; i<dataKeyValues.length; i++){
                ...
                for( var j=0; j < arr_dates.length; j++ ){
                    ...
                    if( typeof obj_data === 'object' ){
                        ...
                        content = '<a href="#" ' + title + '>'+date.toString().substr(-2)+'</a>';
                        hasEventClass = 'hasEvent';
                        customClass = obj_data.customClass;

                    }else{

                        content       = date.toString().substr(-2);
                        hasEventClass = '';
                        customClass   = '';
                    ...
                    if (isWeekend(inputDate)) {
                        html += '<td style="background-color:lightgray; color: dark;"  data-date="' + date + '" data-name="' + name + '" class="data_cell ' + hasEventClass + ' ' + customClass + '">' + date.toString().substr(-2); + '</td>';
                    } else {
                ...
                return [
                    ...
                    '<div class="rescalendar ' , id , '_wrapper">',
                        ...
                        '<div class="rescalendar_controls ">',
                            ...
                            '<br>',
                            '<button style="clear:both;" class="move_to_today btn btn-outline-info btn-sm"> ' + settings.lang.today + ' </button>',

                        '</div><br />',
                        
                        '<table class="rescalendar_table table">',
                            '<thead>',
